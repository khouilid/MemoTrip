...
def generate_application_offline_files(parent_dir):
...
class {file_name_prefix.capitalize().replace("_", "")}State with _${
  ...
  const factory {file_name_prefix.capitalize().replace("_", "")}State.successCreate{file_name_prefix.capitalize().replace("_", "")}({file_name_prefix.capitalize().replace("_", "")}Domain {file_name_prefix.replace("_", "")}Domain , {{ required bool isFresh ,}}) = _SuccessCreate{file_name_prefix.capitalize().replace("_", "")};
  ...
  const factory {file_name_prefix.capitalize().replace("_", "")}State.successGetAll{file_name_prefix.capitalize().replace("_", "")}s(List<{file_name_prefix.capitalize().replace("_", "")}Domain> {file_name_prefix.replace("_", "")}sDomain , {{ required bool isFresh ,}}) = _SuccessGetAll{file_name_prefix.capitalize().replace("_", "")}s;
  ...
  const factory {file_name_prefix.capitalize().replace("_", "")}State.successGet{file_name_prefix.capitalize().replace("_", "")}ById({file_name_prefix.capitalize().replace("_", "")}Domain {file_name_prefix.replace("_", "")}Domain , {{ required bool isFresh ,}} ) = _SuccessGet{file_name_prefix.capitalize().replace("_", "")}ById;
  ...
  const factory {file_name_prefix.capitalize().replace("_", "")}State.successUpdate{file_name_prefix.capitalize().replace("_", "")}({file_name_prefix.capitalize().replace("_", "")}Domain {file_name_prefix.replace("_", "")}Domain , {{ required bool isFresh ,}}) = _SuccessUpdate{file_name_prefix.capitalize().replace("_", "")};
  ...
  const factory {file_name_prefix.capitalize().replace("_", "")}State.successDelete{file_name_prefix.capitalize().replace("_", "")}(bool isDeleted ,{{ required bool isFresh ,}}) = _SuccessDelete{file_name_prefix.capitalize().replace("_", "")};
...
Future<void> create{file_name_prefix.capitalize().replace("_", "")}({file_name_prefix.capitalize().replace("_", "")}Domain  {file_name_prefix.replace("_", "")}Domain) async {{
    ...
    result.fold(
      ...
      (success) => state = {file_name_prefix.capitalize().replace("_", "")}State.successCreate{file_name_prefix.capitalize().replace("_", "")}(success.entity, isFresh: success.isFresh),
    );
}}
...
Future<void> getAll{file_name_prefix.capitalize().replace("_", "")}s() async {{
    ...
    result.fold(
      ...
      (success) => state = {file_name_prefix.capitalize().replace("_", "")}State.successGetAll{file_name_prefix.capitalize().replace("_", "")}s(success.entity, isFresh: success.isFresh),
    );
}}
...
Future<void> get{file_name_prefix.capitalize().replace("_", "")}ById(int id) async {{
    ...
    result.fold(
      ...
      (success) => state = {file_name_prefix.capitalize().replace("_", "")}State.successGet{file_name_prefix.capitalize().replace("_", "")}ById(success.entity, isFresh: success.isFresh),
    );
}}
...
Future<void> update{file_name_prefix.capitalize().replace("_", "")}({file_name_prefix.capitalize().replace("_", "")}Domain  {file_name_prefix.replace("_", "")}Domain) async {{
    ...
    result.fold(
      ...
      (success) => state = {file_name_prefix.capitalize().replace("_", "")}State.successUpdate{file_name_prefix.capitalize().replace("_", "")}(success.entity, isFresh: success.isFresh),
    );
}}
...
Future<void> delete{file_name_prefix.capitalize().replace("_", "")}(int id) async {{
    ...
    result.fold(
      ...
      (success) => state = {file_name_prefix.capitalize().replace("_", "")}State.successDelete{file_name_prefix.capitalize().replace("_", "")}(success.entity, isFresh: success.isFresh),
    );
}}
}}'''
    create_file(dir_path, file_name_prefix, suffix, content)
